...
export const WEEKLY_DEALS_DATA = [
  ...
  },
  {
    ...
    matchedKeywords: ['porc haché', 'porc'],
    department: 'viandes',
    isTopDeal: true
  },
  {
    id: 'deal-03',
    name: 'Bœuf haché mi-maigre format familial',
    store: 'metro',
    storeName: 'Metro',
    category: 'viandes',
    promoPrice: '3.99',
  ...
  },
  {
    ...
    matchedKeywords: ['hauts de cuisse', 'poulet'],
    department: 'viandes',
    isTopDeal: true
  },
  {
    ...
    matchedKeywords: ['crevettes', 'fruits de mer'],
    department: 'viandes',
    isTopDeal: true
  },
  {
  ...
  {
    id: 'deal-13b',
    name: 'Oignons jaunes du Québec (sac de 3 lb / 1.36 kg)',
    store: 'maxi',
    storeName: 'Maxi',
    category: 'fruits_legumes',
    promoPrice: '1.77',
    ...
    matchedKeywords: ['oignon', 'oignons', 'fajitas'],
    department: 'fruits_legumes',
    isTopDeal: false
  },
  {
    id: 'deal-13c',
    name: 'Champignons blancs entiers frais (227g)',
    store: 'superc',
    storeName: 'Super C',
    category: 'fruits_legumes',
    promoPrice: '1.49',
    unit: 'barquette de 227g',
    originalPrice: '2.99 $',
    discount: '-50%',
    validUntil: 'Mercredi prochain',
